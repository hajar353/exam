    ...
    for (const meal of meals) {
      box += `<div class="col-md-4 col-lg-3 ">
        <div data-meal="${meal.strCategory}" class="item ">
          ...
          <div class="layer justify-content-center flex-column rounded-2 px-2 text-center h-100">
  ...
  function titleDisplay(object) {
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure1} ${
      object.strIngredient1
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure2} ${
      object.strIngredient2
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure3} ${
      object.strIngredient3
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure4} ${
      object.strIngredient4
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure5} ${
      object.strIngredient5
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure6} ${
      object.strIngredient6
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure7} ${
      object.strIngredient7
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure8} ${
      object.strIngredient8
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure9} ${
      object.strIngredient9
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure10} ${
      object.strIngredient10
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure11} ${
      object.strIngredient11
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure12} ${
      object.strIngredient12
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure13} ${
      object.strIngredient13
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure14} ${
      object.strIngredient14
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure15} ${
      object.strIngredient15
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure16} ${
      object.strIngredient16
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure17} ${
      object.strIngredient17
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure18} ${
      object.strIngredient18
        ...
        })()} text-bg-secondary alert alert-info  fs-6 m-2">${object.strMeasure19} ${
      object.strIngredient19
        ...
        })()} text-bg-secondary  alert alert-info  fs-6 m-2">${object.strMeasure20} ${
      object.strIngredient20
    }</span>
        
        <div class="tags mt-3"><h2>Tags  :</h2>
        <span class="badge  alert alert-danger p-2 fs-6 m-2">${
